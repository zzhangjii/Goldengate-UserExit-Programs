/**************************************************************************
 Copyright (c) 2001, 2017, Oracle and/or its affiliates. All rights reserved.
  ...
  MODIFIED   (MM/DD/YY)
  yoshbaba    05/05/17 - bug-25797611 added Oracle hidden column support.
  yoshbaba    01/05/17 - Consolidate SQL data type definitions into SQLDataTypes.h
  jennwei     03/22/16 - lrg 18738350 - import the additional types introduced
                         in ggapp/DBObjType.h
...
#define CALLBACK_STRUCT_VERSION     5
...
typedef enum
{
    ...
    MAXDBOBJTYPE_122,      ///< max, invalid on 12.2 or earlier.

    DBPACKAGE = MAXDBOBJTYPE_122,  ///< package
