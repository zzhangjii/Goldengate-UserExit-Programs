/**************************************************************************
 Copyright (c) 1995, 2013, Oracle and/or its affiliates. All rights reserved. 
  ...
  03/06/13 - yoshbaba
   Added three part table name support.
  ...
  12/08/08 - TAS
   OS-8263 Corrected mem leak in get_table_metadata()

  11/21/08 - JKT
    OS-6698 - UserExit: Modified code to support LOB in Open System database namely
    (Sybase, SQLServer and DB2).
