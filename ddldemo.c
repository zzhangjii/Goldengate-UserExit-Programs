/**************************************************************************
 * Sherman Lee  & Ji Zhang
 * 05/16/2019
 * Oracle Solutions Hub Santa Monica
***************************************************************************/
                      ...
                      short ascii_or_internal)
{
    ...
    /* Pass the ddl_str to a outside shell script and run the script 
      The script should connect to the target DB (ex: using sqlplus) and run this DDL statement.
    */
    char ShellScript[200]="./home/opc/DDL.sh";
    strcat(ShellScript, ddl_str);       
    int rc = system (ShellScript); 

    /* TODO, based on the returned value, determine if executing this DDL statement is successful
       If so, exit UserExit program, else, halt and send out warnings to DBA.
     */
    /*
    TODO
    TODO
