/**************************************************************************
 ...
 Copyright (c) 2008, 2016, Oracle and/or its affiliates. All rights reserved.
  ...
  Change History:
  12/05/12 Yoshi
    Added more Oracle NLSRTL character set support.

  05/18/12 Yoshi
    Added Oracle NLSRTL character set support.

  02/15/12 Yoshi
    Added more IBM CCSID code support.

  10/21/11 Yoshi
    Added HP Roman8 character set.

  10/26/10  Yoshi
    Initial version. Split from ulib.h for VAM integration.
